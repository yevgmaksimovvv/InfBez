"""
Константы для алгоритма Стрибог (ГОСТ 34.11-2018)
Все константы соответствуют стандарту ГОСТ 34.11-2018
"""

# Линейное преобразование множества двоичных векторов через матрицу A
A = [
    0x8e20faa72ba0b470,
    0x47107ddd9b505a38,
    0xad08b0e0c3282d1c,
...
# Итерационные константы Ci, где i=(0..=12)
C = [
    [
